...
define([
   ...
   * ```
   *
   * @description Creates a type metadata instance and, optionally, registers it in a given context.
  ...
  var Type = Base.extend("pentaho.data.meta.Type", /** @lends pentaho.data.meta.Type# */{
     ...
     *
     * The unique type id is autogenerated upon {@link pentaho.data.meta.Type.extend}.
