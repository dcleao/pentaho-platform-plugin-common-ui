...
define([
  ...
  return Base.extend("pentaho.component.SingleValueLabel", /** @lends pentaho.component.SingleValueLabel# */{
    /**
     * @alias SingleValueLabel
     ...
     *
     * @classdesc The `SingleValueLabel` class represents
     * a pair of a property value and its label.
     *
     * ### AMD
     *
     * To obtain the constructor of this class,
     * require the module `"pentaho/component/SingleValueLabel"`.
     *
