...
define([
  ...
  var Property = Item.extend("pentaho.type.Property", /** @lends pentaho.type.Property# */{
    ...
    meta: /** @lends pentaho.type.Property.Meta# */{
      ...
      /**
       * The base type of the value that the property can hold.
       *
      ...
      /**
       * Converts the given value specification to a value of
      ...
      toValue: function(valueSpec) {
        ...
        if(valueSpec == null) {
          // TODO: move the defaulting of the defaultValue for the list case to the defaultValue attribute...
        ...
        var type = this.type;
        return this.context.create(valueSpec, type, type);
      },
      //endregion
