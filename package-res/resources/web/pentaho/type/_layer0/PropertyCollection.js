...
define([
   ...
   */
  return Collection.extend("pentaho.type.PropertyCollection", /** @lends pentaho.type.PropertyCollection# */{

    /**
     * Initializes a properties  collection.
     *
     * @param {Object} keyArgs Keyword arguments object.
     * @param {pentaho.type.Complex} keyArgs.owner The complex type instance.
     * @ignore
     */
     ...
     *
     * @param {Object.<string,pentaho.type.spec.IPropertyConfig} propConfigs A map of property configurations.
     */
