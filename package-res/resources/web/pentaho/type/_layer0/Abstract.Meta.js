...
define([
  ...
  // Unique type class id exposed through AbstractMeta#uid and used by Context instances.
  var _nextUid = 1;
  ...
  var AbstractMeta = Base.extend("pentaho.type.Abstract.Meta",
    ...
    _extend: function(name, instSpec) {
      ...
      var id = O["delete"](instSpec, "id") || null;

      // All other instSpec/classSpec options are specified
      // after initial construction using mix. See `Abstract._extend`.
      var DerivedMeta = this.base(name, {constructor: instSpec.constructor});
      ...
      derivedProto._styleClass = null;
      derivedProto._abstract   = false;
