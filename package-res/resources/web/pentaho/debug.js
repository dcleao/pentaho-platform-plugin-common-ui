...
define([
  "module",
  "./service!Class<pentaho.IDebugManager>?single",
  "./DebugLevels",
  "./util/domWindow"
], function(module, DebugManagerImpl, DebugLevels, domWindow) {
  ...
  /**
   * The `pentaho.debug` singleton provides access to the main Pentaho Web Client Platform's
   * debugging manager.
   *
   ...
   * @name debug
   * @memberOf pentaho
   * @type pentaho.IDebugManager
   * @amd pentaho/debug
   */

  var mgr = new DebugManagerImpl();
  mgr.configure(spec);
  return mgr;
