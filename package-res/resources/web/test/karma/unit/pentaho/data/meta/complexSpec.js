...
define([
  ...
  "pentaho/data/meta/_layer0/PropertyClassCollection",
  "pentaho/util/error"
], function(Complex, Type, StringMeta, PropertyClass, PropertyClassCollection, error) {
  "use strict";

  /*global describe:true, it:true, expect:true, beforeEach:true*/

  describe("pentaho/data/meta/complex -", function() {
    describe("anatomy -", function() {
      it("is a function", function() {
        expect(typeof Complex).toBe("function");
      });

      it("is a sub-class of Type", function() {
        expect(Complex).not.toBe(Type);
        expect(Complex.prototype instanceof Type).toBe(true);
      });

      it("has different 'info' attributes from those of Type", function() {
        expect(Complex.prototype.name).not.toBe(Type.prototype.name);
        expect(Complex.prototype.namePlural).not.toBe(Type.prototype.namePlural);

        expect(Complex.prototype.label).not.toBe(Type.prototype.label);
        expect(Complex.prototype.labelPlural).not.toBe(Type.prototype.labelPlural);

        expect(Complex.prototype.description).not.toBe(Type.prototype.description);
      });
