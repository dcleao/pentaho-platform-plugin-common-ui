---
title: Step 3 - Creating the model
...
The model could still be enriched by providing localized labels and descriptions for its properties.
However, this is accessory and can be done at a later stage.

**Continue** to [Creating the view](step4-view-creation).
