  ...
  return BaseView.extend(module.id, {
    ...
    _buildRadarRecords: function(dataTable, visualData, radarIndicators) {
      ...
      function buildRecord(seriesEntity, seriesTableView) {
        ...
        // Given that series x category together form the [visual key]{@link pentaho.visual.role.AbstractPropertyType#isVisualKey},
        ...
        // 2nd phase.
        // Now build the record values ECharts structure in the same order of the overall categories entities x measures,
