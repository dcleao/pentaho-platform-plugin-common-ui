...
define([
  ...
  "pentaho/util/object",
  "pentaho/util/error"
], function(module, paletteLevelFactory, paletteFactory, bundle, ValidationError, typeUtil, O, error) {
  ...
  return function(context) {
    ...
    var __paletteLevelType = context.get(paletteLevelFactory).type;
    var __ListLevelType = context.get([paletteLevelFactory]);
     ...
     *
     * @amd {pentaho.type.Factory<pentaho.visual.color.PaletteProperty>} pentaho/visual/color/paletteProperty
     *
     ...
     */
    var PaletteProperty = __Property.extend(/** @lends pentaho.visual.color.PaletteProperty# */{

      $type: /** @lends pentaho.visual.color.PaletteProperty.Type# */{

        id: module.id,

        valueType: paletteFactory,
        ...
        defaultValue: function(propType) {
          ...
          return propType.context.instances.getByType(propType.valueType, {
            ...
            filter: function(palette) { return validLevels.includes(palette.level); },

            // Don't use the same palette twice in the same top-level resolve
