...
define([
  ...
  "pentaho/i18n!types",
  "pentaho/config!"
], function(module, Element, PropertyTypeCollection, typeUtil, ContainerMixin, ComplexChangeset,
            ActionResult, UserError, O, error, bundle, config) {
  ...
  .implement({$type: bundle.structured.complex})
