...
define([
  ...
  "pentaho/i18n!types",
  "pentaho/config!"
], function(module, Simple, O, F, logger, bundle, config) {
   ...
   */
  var PentahoFunction = Simple.extend(/** @lends pentaho.type.Function# */{
    /**
  ...
  .implement({$type: bundle.structured["function"]}) // eslint-disable-line dot-notation
