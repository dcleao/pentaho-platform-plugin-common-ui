...
define([
  ...
  "pentaho/i18n!types",
  "pentaho/config!"
], function(module, Instance, DiscreteDomain, typeUtil, ValidationError, arg, error, O, text, F, bundle, config) {
  ...
  var Property = Instance.extend(/** @lends pentaho.type.Property# */{
    ...
    $type: /** @lends pentaho.type.Property.Type# */{
       ...
       * and is first resolved using [Type.get]{@link pentaho.type.Type.get}.
       *
      ...
      set valueType(value) {
        ...
        // TODO: ATTENTION: How to know we're applying configuration, here or on any other subtype of property.
        // Need a configure method to scope the change...?
        ...
        var newType = Instance.Type.get(value, {defaultBase: defaultBaseType}).type;
        if(newType !== oldType) {
