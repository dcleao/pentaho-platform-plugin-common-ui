...
define([
  ...
  "pentaho/i18n!types",
  "pentaho/config!"
], function(module, Type, SpecificationScope, Base, O, bundle, config) {
   ...
   */
  var Instance = Base.extend(module.id, /** @lends pentaho.type.Instance# */{
    ...
    set type(config) {
      if(config) {
        this.type.constructor.implementStatic(config);
      }
    }, // endregion
