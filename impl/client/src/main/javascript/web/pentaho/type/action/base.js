...
define([
  ...
  "pentaho/util/object",
  "pentaho/config!"
], function(module, Element, States, ArgumentRequiredError, ArgumentInvalidTypeError, OperationInvalidError,
            UserError, RuntimeError, debugMgr, DebugLevels, logger, O, config) {
