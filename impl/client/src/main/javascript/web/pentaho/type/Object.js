...
define([
  ...
  "pentaho/i18n!types",
  "pentaho/config!"
], function(module, Simple, O, bundle, config) {
   ...
   */
  var PentahoObject = Simple.extend(/** @lends pentaho.type.Object# */{
  ...
  .implement({$type: bundle.structured["object"]}) // eslint-disable-line dot-notation
