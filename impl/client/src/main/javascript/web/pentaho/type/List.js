...
define([
  ...
  "pentaho/i18n!types",
  "pentaho/config!"
], function(module, Type, Value, Element, ContainerMixin, ListChangeset,
            SpecificationContext, typeUtil, arg, error, O, bundle, config) {
  ...
  var List = Value.extend(/** @lends pentaho.type.List# */{
    ...
    $type: /** @lends pentaho.type.List.Type# */{
      ...
      set of(value) {
        ...
        var ElemInstance = Type.get(value);
  ...
  .implement({$type: bundle.structured.list})
