...
define([
  ...
  "pentaho/i18n!types",
  "pentaho/config!"
], function(module, Simple, dateUtil, bundle, config) {
   ...
   */
  var PentahoDate = Simple.extend(/** @lends pentaho.type.Date# */{
    /**
  ...
  .implement({$type: bundle.structured["date"]})  // eslint-disable-line dot-notation
